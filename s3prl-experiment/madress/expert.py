...
from .dataset import MadressDataset
...
class DownstreamExpert(nn.Module):
    ...
    def __init__(self, upstream_dim, upstream_rate, downstream_expert, expdir, **kwargs):
        ...
        self.train_dataset = MadressDataset(**self.datarc)
        self.dev_dataset = MadressDataset(**self.datarc)
        self.test_dataset = MadressDataset(**self.datarc)
